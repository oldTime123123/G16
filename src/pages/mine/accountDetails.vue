	...
	<view :style="store.$state.imgObj.loginBg">
		...
		<view class="pdlr35 pt33">
			...
			<view class="mt58 between f28"
				style="background-color: #ddd;border-radius: 20rpx;	overflow: hidden;height: 90rpx;">
			...
			<z-paging class="mt24 " ref="paging" v-model="botList" @query="getData" :refresher-enabled="false"
				...
				:loading-more-fail-text="t('record.r_r3')" style="margin: 400rpx auto 0;width: 100%;  " :auto="false">
