<template>
	<view :style="store.$state.imgObj.loginBg">
		...
		<view class="pdlr35 pt33">
			...
			<view class="choItem mt38" @click="changeChoosed('showUSDCErc')" :style="cType == 'showUSDCErc' ? choStyle : ''"
				v-if="showUSDCErc">
				<view class="flex">
			...
			<view class="choItem mt38" @click="changeChoosed('showUSDCBep')" :style="cType == 'showUSDCBep' ? choStyle : ''"
				v-if="showUSDCBep">
				<view class="flex">
