<template>
	<!-- ext="t('all.a_c2')" :ok-text="t('all.a_c1')"  -->
		...
		<view class="pdlr35 pt33" :style="{ color: store.$state.secondColor }">
			...
			<view class="mt29">
				...
				<view class="mt34">
					...
					<input class="inp" placeholder-class="plo" :placeholder="t('inp.i_a3')" disabled v-model="bName"
						@click="show = true">
			...
			<view class="mt38">
				...
				<view class="mt34">
					<input class="inp" placeholder-class="plo" :placeholder="t('inp.i_a5')" v-model="formData.bank_num">
				</view>
			</view>
