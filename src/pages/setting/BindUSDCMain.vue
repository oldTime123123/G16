	...
	<view :style="store.$state.imgObj.loginBg">
		...
		<view class="pdlr35 pt33" :style="{ color: store.$state.secondColor }">
			...
			<view class="mt29">
				...
				<view class="mt34">
					<input class="inp" placeholder-class="plo" :placeholder="t('x.a1')" v-model="formData.address">
				</view>
			</view>
...
onLoad((e) => {
	type.value = e.type
	if (type.value == 8) {
		text.value = 'USDC-BEP20'
	}
	if (type.value == 9) {
		text.value = 'USDC-ERC20'
	}
	if (type.value == 10) {
		text.value = 'USDC-TRC20'
	}
})
</script>
